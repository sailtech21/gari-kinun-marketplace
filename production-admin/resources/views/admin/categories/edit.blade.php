            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="Car" {{ old('type', $category->type) == 'Car' ? 'selected' : '' }}>Car</option>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <small class="text-muted">Leave empty to keep as main category</small>
                        @error('parent_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                @if($category->listings_count > 0)
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> This category has <strong>{{ $category->listings_count }} listing(s)</strong>.
                        Changes will affect existing listings.
                    </div>
                @endif

                @if($category->children->count() > 0)
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle"></i> This category has <strong>{{ $category->children->count() }} subcategory(ies)</strong>.
