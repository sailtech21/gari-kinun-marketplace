...
function renderAdvertisementCard(ad) {
    ...
    const imageUrl = ad.image ? `/storage/${ad.image}` : '/placeholder-ad.jpg';
    ...
    return `
        <div class="col-md-6 col-lg-4">
            <div class="advertisement-card ${statusClass}">
                <img src="${imageUrl}" alt="${ad.title}" class="advertisement-image" onerror="this.src='/placeholder-ad.jpg'">
